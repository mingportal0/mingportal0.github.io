...
#### 2. 글 작성
Typora에서는 마크다운 문법에 따라 자동으로 해주는 것들이 있고 StackEdit에서는 이런 것들이 없다. 그래서 글 작성하다 보면 깃허브에서 이상하게 출력되는 게 있다. Typora가 정말 깃허브 페이지에 가깝게 표현해주는 것 같다. 또한 Typora에서 쓰던 단축키를 사용 못하게 되니 좀 답답해지
그래도 StackEdit 쓰면서 마크다운 문법에 다시 익숙해져봐야 겠다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ4ODIyNzQ4MSwxMDQ3NDAwNDI2LDEzNj
